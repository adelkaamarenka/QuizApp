export const resultContent = {
    ...
    b: {
        ...
        description: "Everyone knows you and they all love you. You’re extroverted and the life of the party. People can never be bored around you!",
    },
    c: {
        title: "Margherita",
        img: "./images/Pizzas/margherita2.jpg",
    ...
    d: {
        title: "Olives and artichoke pizza",
        img: "./images/Pizzas/oliven.jpg",
        description: "You're an intellectual that appreciates the finer things that life has to offer. You have sophisticated taste when it comes to fashion, friends, and food.",
    },
}
